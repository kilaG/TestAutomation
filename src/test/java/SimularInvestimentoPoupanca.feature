...
@tag
Feature: Simular investimento na poupança   
    
   @tag1
   Scenario: Simular investimento na poupança com dados validos
   ...
   Then O sistema exibe uma mensagem "Valor mínimo de 20.00" deve ser exibida".
